...
MODEL_DIR = '/root/autodl-tmp/.autodl/StockPredictor_NASDAQ/model/mlp_MSEloss'
PREDICTION_DIR = '/root/autodl-tmp/.autodl/StockPredictor_NASDAQ/outputs/prediction_mlp_MSEloss'
...
def main():
    ...
    logger.info("=" * 80)
    logger.info("开始执行MLP-MSEloss模型预测任务")
    logger.info("=" * 80)
    ...
    logger.info("\n" + "=" * 80)
    logger.info("MLP-MSEloss模型预测任务完成!")
    logger.info("=" * 80)
